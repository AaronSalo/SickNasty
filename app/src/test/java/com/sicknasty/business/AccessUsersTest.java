...
//        assertNotNull("user not added",userPersistence.insertUser(new User("Jay K","jay","abcmmdef")));
//        assertNull("duplicated  added!!!Error",userPersistence.insertUser("Jay K","jay","abcmmdef"));
//
//        assertTrue(" not deleted!!error",userPersistence.deleteUser("aaron"));
//        assertTrue("existing user not deleted !!error",userPersistence.deleteUser("jay"));
//    }
//
//    @Test
